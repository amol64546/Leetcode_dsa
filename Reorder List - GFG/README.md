# Reorder List
## Hard
<div class="problems_problem_content__Xm_eO"><p>Given a singly linked list<em>: A</em>0→<em>A</em>1→...→<em>A</em><em>n</em>-2→<em>A</em>n-1, reorder it to: <em>A</em>0→<em>A</em><em>n-1</em>→<em>A</em>1→<em>A</em><em>n</em>-2→<em>A</em>2→<em>A</em><em>n</em>-3→...<br>
...
order is<em> A</em>0→<em>A</em><em>2</em>→<em>A</em><em>1</em><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
...
order is<em> A</em>0→<em>A</em><em>3</em>→<em>A</em><em>1</em>→<em>A</em><em>2</em><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
